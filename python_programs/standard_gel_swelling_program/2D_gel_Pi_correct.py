...
vtkfile_u = File("2D_gel_D1_t4_final/displacement.pvd");
vtkfile_mu = File("2D_gel_D1_t4_final/chemical_potential.pvd");
vtkfile_phi = File("2D_gel_D1_t4_final/polumer_volume_fraction.pvd");
vtkfile_stress = File("2D_gel_D1_t4_final/cauchy_stress.pvd");
