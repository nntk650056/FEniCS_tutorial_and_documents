...
vtkfile_u = File("2D_gel_D_swelling/displacement.pvd");
vtkfile_mu = File("2D_gel_D_swelling/chemical_potential.pvd");
vtkfile_phi = File("2D_gel_D_swelling/polumer_volume_fraction.pvd");
vtkfile_stress = File("2D_gel_D_swelling/cauchy_stress.pvd");
...
W_FC = 0.5*Nv*(lambda0**2*Ic/(lambda_ref**2)-3-2*ln(lambda0**3*det(F)/(lambda_ref**3))) - C1*(ln(1+1/C1))-chi/(1+C1)
